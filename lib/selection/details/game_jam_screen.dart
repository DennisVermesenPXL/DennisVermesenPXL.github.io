...
import 'package:web_portfolio/selection/details/game_jam_body.dart';
...
class GameJamScreen extends StatefulWidget {
  const GameJamScreen({super.key});

  @override
  State<GameJamScreen> createState() => _GameJamScreenState();
}

class _GameJamScreenState extends State<GameJamScreen> {
