...
import 'package:web_portfolio/selection/details/game_dev_body.dart';
...
class GameDevScreen extends StatefulWidget {
  const GameDevScreen({super.key});

  @override
  State<GameDevScreen> createState() => _GameDevScreenState();
}

class _GameDevScreenState extends State<GameDevScreen> {
